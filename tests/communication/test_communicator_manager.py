...
def test_returns_communicator_manager(__setup_interface_registry):
  assert xmipp4.communication.get_communicator_manager(
    __setup_interface_registry
  ) is not None

def test_always_returns_same_communicator_manager(__setup_interface_registry):
  cm1 = xmipp4.communication.get_communicator_manager(__setup_interface_registry)
  cm2 = xmipp4.communication.get_communicator_manager(__setup_interface_registry)
  assert cm1 is cm2
